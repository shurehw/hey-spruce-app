...
class OpenWrenchClient {
  constructor() {
    this.apiKey = process.env.OPENWRENCH_API_KEY;
    this.owKey = process.env.OPENWRENCH_KEY;
    this.baseURL = process.env.OPENWRENCH_API_URL || 'https://api.openwrench.com';
...
module.exports = OpenWrenchClient;